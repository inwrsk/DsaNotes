...
public class A_Tiling {
    ...
    public static Integer tiling(Integer n) {
        if (n.equals(0)) {// if there are no space in the floor then there is no way to place the tile
            return 0;
        }
        if (n.equals(1)) {// if there is only 1 tile space left on the floor then there is only 1 way to place the tile
            return 1;
        }
        if (n.equals(2)) {// if there are 2 tile space left on the floor then there are 2 ways to place the tile
